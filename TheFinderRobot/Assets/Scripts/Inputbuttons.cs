    ...
    private void FuncButton(ref int func_num, int but) {
        if (func_num != but) {
            ...
            for (int i = 0; i < buton_num; i++) {
                ...
                if (playbutton.GetComponent<Button_play>().func[func_num].input_arr[i].color == (int) Input_Class.Colors.Blue)
                    button_list[i].image.color = new Color(0.2763439F, 0.6294675F, 0.8490566F, 1F);
                if (playbutton.GetComponent<Button_play>().func[func_num].input_arr[i].color == (int) Input_Class.Colors.Green)
                ...
                if (playbutton.GetComponent<Button_play>().func[func_num].input_arr[i].direct == (int) Input_Class.Directs.right)
                    button_list[i].image.sprite = choosebutton.GetComponent<Choosebutton>().s1[3];
                if (playbutton.GetComponent<Button_play>().func[func_num].input_arr[i].direct == (int) Input_Class.Directs.forward)
